                ...
                <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                    ...
                    {isTeacher && (
                        <>
                            ...
                            <button className="btn" onClick={handleDelete} title={t.deleteProject} style={{padding: '6px 10px', background: 'rgba(248,81,73,0.15)', color: '#F85149', border: '1px solid #F85149', display: 'flex', alignItems: 'center'}}>
